  	...
  	<div class="container-fluid">
		<div class="col-md-12">
			<h3 style="font-size: 20px;">
				...
				<a href="<?php echo base_url('editar_visita/'.$visita->id); ?>" style="color: #000; text-decoration: none">Editar</a>
			</h3>
			<hr/>
			<?php if(isset($error_login)){ echo "<p>".$error_login."</p>"; } ?>
			<?php echo validation_errors(); ?>
			<?php echo form_open_multipart('editar_visita_form/', 'id="uploadImageForm"'); ?>
			<div class="panel panel-default col-md-12 col-sm-12 paneles_form">
				...
				<div class="panel-body">
	        		...
	        		<div class="col-md-2 col-sm-12" style="padding: 10px;">
						<label>Fecha</label>
						<div class="input-group">
							<input class="form-control" type="text" id="fecha" name="fecha" value="<?php echo $fecha_buena; ?>" required>
						</div>
					</div>
					<div class="col-md-2 col-sm-12" style="padding: 10px;">
						<label>Imágen</label>
					...
					<div id="checklist" class="col-md-12 col-sm-12" style="padding: 0; margin-top: 10px;">
						...
						<div class="col-md-2 col-sm-12">
							<label>Fachada</label>
							<div class="input-group">
								<input type="checkbox" name="check_list[]" value="car_obl1" class="checklist" <?php if(isset($visitas_checklist->car_obl1) && $visitas_checklist->car_obl1 == 1){ echo "checked"; } ?>>
						...
						<div class="col-md-2 col-sm-12">
							<label>Córner</label>
							<div class="input-group">
								<input type="checkbox" name="check_list[]" value="vin_est" class="checklist" <?php if(isset($visitas_checklist->vin_est) && $visitas_checklist->vin_est == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Vinilo buen estado</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="bol_pla" class="checklist" <?php if(isset($visitas_checklist->bol_pla) && $visitas_checklist->bol_pla == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Boletines / Placas terminales</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="san_cab" class="checklist" <?php if(isset($visitas_checklist->san_cab) && $visitas_checklist->san_cab == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Saneamiento cableado Basic</label>
				    		</div>
							<div class="input-group">
								<input type="checkbox" name="check_list[]" value="car_obl2" class="checklist" <?php if(isset($visitas_checklist->car_obl2) && $visitas_checklist->car_obl2 == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Carteles obligatorios</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="fol_lud" class="checklist" <?php if(isset($visitas_checklist->fol_lud) && $visitas_checklist->fol_lud == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Folletos juego responsable</label>
				    		</div>				    		
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="tvs_cor" class="checklist" <?php if(isset($visitas_checklist->tvs_cor) && $visitas_checklist->tvs_cor == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">TV's emitiendo canales deportivos</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="ver_act" class="checklist" <?php if(isset($visitas_checklist->ver_act) && $visitas_checklist->ver_act == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Vertical actualizada</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="cor_est" class="checklist" <?php if(isset($visitas_checklist->cor_est) && $visitas_checklist->cor_est == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Córner en buen estado</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="ter_inc" class="checklist" <?php if(isset($visitas_checklist->ter_inc) && $visitas_checklist->ter_inc == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Terminales en buen estado</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="dis_may" class="checklist" <?php if(isset($visitas_checklist->dis_may) && $visitas_checklist->dis_may == 1){ echo "checked"; } ?>>
						...
						<div class="col-md-2 col-sm-12">
							<label>TPV</label>
							<div class="input-group">
								<input type="checkbox" name="check_list[]" value="tpv_inc" class="checklist" <?php if(isset($visitas_checklist->tpv_inc) && $visitas_checklist->tpv_inc == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">TPV sin incidencias</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="lec_tar" class="checklist" <?php if(isset($visitas_checklist->lec_tar) && $visitas_checklist->lec_tar == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Lector de tarjetas</label>
				    		</div>
							<div class="input-group">
								<input type="checkbox" name="check_list[]" value="com_pro" class="checklist" <?php if(isset($visitas_checklist->com_pro) && $visitas_checklist->com_pro == 1){ echo "checked"; } ?>>
						...
						<div class="col-md-2 col-sm-12">
							<label>Otros</label>
							<div class="input-group">
								<input type="checkbox" name="check_list[]" value="per_for" class="checklist" <?php if(isset($visitas_checklist->per_for) && $visitas_checklist->per_for == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Personal de apuestas formado</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="inc_apu" class="checklist" <?php if(isset($visitas_checklist->inc_apu) && $visitas_checklist->inc_apu == 1){ echo "checked"; } ?>>
						...
						<div class="col-md-2 col-sm-12">
							...
							<div class="input-group" style="margin: 5px 0">
								<input class="form-control" type="text" id="taburete" name="taburete" placeholder="Taburetes" value="<?php echo $visita->taburete; ?>">
							</div>
							<div class="input-group" style="margin: 5px 0">
								<input class="form-control" type="text" id="mesa" name="mesa" placeholder="Mesa alta" value="<?php echo $visita->mesa; ?>">
							</div>
							<div class="input-group" style="margin: 5px 0">
								<input class="form-control" type="text" id="tablero" name="tablero" placeholder="Tableros" value="<?php echo $visita->tablero; ?>">
							</div>
						</div>
						<div class="col-md-2 col-sm-12">
							<label>Señales</label>
							<div class="input-group">
								<input type="checkbox" name="check_list[]" value="señ_gal" class="checklist" <?php if(isset($visitas_checklist->señ_gal) && $visitas_checklist->señ_gal == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Galgos</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="señ_lot" class="checklist" <?php if(isset($visitas_checklist->señ_lot) && $visitas_checklist->señ_lot == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Lottos</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="señ_dep" class="checklist" <?php if(isset($visitas_checklist->señ_dep) && $visitas_checklist->señ_dep == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Deportes</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="señ_otr" class="checklist" <?php if(isset($visitas_checklist->señ_otr) && $visitas_checklist->señ_otr == 1){ echo "checked"; } ?>>
						...
						<div class="col-md-2 col-sm-12">
							<label>Fachada</label>
							<div class="input-group">
								<input type="checkbox" name="check_list[]" value="ban_fac" class="checklist" <?php if(isset($visitas_checklist->ban_fac) && $visitas_checklist->ban_fac == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Banderola</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="fac_vin" class="checklist" <?php if(isset($visitas_checklist->fac_vin) && $visitas_checklist->fac_vin == 1){ echo "checked"; } ?>>
						...
						<div class="col-md-2 col-sm-12">
							<label>Córner</label>
							<div class="input-group">
								<input type="checkbox" name="check_list[]" value="aio_est" class="checklist" <?php if(isset($visitas_checklist->aio_est) && $visitas_checklist->aio_est == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">AIO buen estado</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="piz_int" class="checklist" <?php if(isset($visitas_checklist->piz_int) && $visitas_checklist->piz_int == 1){ echo "checked"; } ?>>
				    	...
				    	<div class="col-md-2 col-sm-12">
							...
							<div class="input-group">
								<input type="checkbox" name="check_list[]" value="per_uni" class="checklist" <?php if(isset($visitas_checklist->per_uni) && $visitas_checklist->per_uni == 1){ echo "checked"; } ?>>
						...
						<div class="col-md-2 col-sm-12">
							<label>Otros</label>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="pan_car" class="checklist" <?php if(isset($visitas_checklist->pan_car) && $visitas_checklist->pan_car == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Adquisición y uso de panel de cartelería</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="car_pro" class="checklist" <?php if(isset($visitas_checklist->car_pro) && $visitas_checklist->car_pro == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Imprimir cartelera deportiva</label>
				    		</div>
							<div class="input-group">
								<input type="checkbox" name="check_list[]" value="tar_adm" class="checklist" <?php if(isset($visitas_checklist->tar_adm) && $visitas_checklist->tar_adm == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Disponer de tarjetas ADM</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="lim_loc" class="checklist" <?php if(isset($visitas_checklist->lim_loc) && $visitas_checklist->lim_loc == 1){ echo "checked"; } ?>>
								<label style="font-weight: 100; margin-left: 5px; vertical-align: top;">Revisar limpieza local</label>
				    		</div>
				    		<div class="input-group">
								<input type="checkbox" name="check_list[]" value="ent_mer" class="checklist" <?php if(isset($visitas_checklist->ent_mer) && $visitas_checklist->ent_mer == 1){ echo "checked"; } ?>>
					...
					<div class="col-md-12 col-sm-12" style="padding: 10px;">
						...
						<div class="input-group">
							<textarea class="form-control" name="texto" rows="6" placeholder="Observaciones..."><?php echo $visita->observaciones; ?></textarea>
						</div>
					</div>
				</div>				
			</div>
...
$(function(){
	if($('#operador').val() == 3 || $('#operador').val() == 10){
