...
tiemposcambian.GuardandoPNGs = (function() {
  ...
  function sendToServer() {
    ...
    $.ajax({
      type: "POST",
      url: "http://atc.apuestasdemurcia.es/tickets/guardar_firma_recaudacion",
      data: { 
         img1: firma1,
         img2: firma2,
         reca: reca,
         salon: salon
      	...
      	window.location.href = "http://atc.apuestasdemurcia.es/tickets/recaudacion_finalizada/"+reca;
    });
  }
