  ...
  <div class="container-fluid">
		<div class="col-md-12">
			<h3 style="font-size: 20px;">
				...
				<a href="<?php echo base_url('nuevo_personal'); ?>" style="color: #000; text-decoration: none">Nuevo</a>
			</h3>
			<hr/>
			<?php if(isset($error_login)){ echo "<p>".$error_login."</p>"; } ?>
			<?php echo validation_errors(); ?>
			<?php echo form_open_multipart('nuevo_personal_form/', 'id="myform"'); ?>
			<div class="panel panel-default col-md-12 col-sm-12 paneles_form">
				...
				<div class="panel-body">
					...
					<div class="col-md-3 col-sm-12" style="padding: 10px;">
						<label>DNI</label>
						<div class="input-group">
							<input class="form-control" type="text" size="10" maxlength="9" name="dni" pattern="(([X-Z]{1})([-]?)(\d{7})([-]?)([A-Z]{1}))|((\d{8})([-]?)([A-Z]{1}))" title="Introduzca el dni" required>
					...
					<div class="col-md-3 col-sm-12" style="padding: 10px;">
						...
						<div class="input-group">
							<input class="form-control" type="text" id="reg" name="reg" inputmode="numeric" maxlength="4">
						</div>
					</div>				
	        		...
	        		<div class="col-md-3 col-sm-12" style="padding: 10px;">
						...
						<div class="input-group">
							<input class="form-control" type="text" id="fecha_carnet" name="fecha_carnet">
						</div>
					</div>
					<div class="col-md-3 col-sm-12" style="padding: 10px;">
						<label>Fecha Formación</label>
						<div class="input-group">
							<input class="form-control" type="text" id="fecha_formacion" name="fecha_formacion">
						</div>
					</div>
					<div class="col-md-3 col-sm-12" style="padding: 10px;">
						<label>Nota Test</label>
						<div class="input-group">
							<input class="form-control" type="text" id="nota" name="nota" inputmode="numeric" maxlength="4">
						</div>
					</div>					
