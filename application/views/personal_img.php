<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
  <div class="container-fluid">
  	<h3 style="font-size: 20px;">
			<a href="<?php echo base_url('personal/1/'); ?>" style="text-decoration: underline; color: #c10d3e;">
				<i style="color: #c10d3e;" class="fa fa-arrow-circle-left"></i> Personal</a>
			<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span>
			<a style="color: #000; text-decoration: none"><?php echo $persona->nombre; ?></a></a>
		</h3>
		<hr/>
...
<script>
  $("#input-id").fileinput({
  	...
  	maxFileSize: 2000,
  	uploadUrl: "https://atc.apuestasdemurcia.es/tickets/upload_images_personal/<?php echo $persona->id; ?>"
  }).on('fileuploaded', function(event, data, previewId, index) {
  	setTimeout(function(){ window.location.href = "../personal_img/<?php echo $persona->id; ?>"; }, 3000);
	});
</script>
</html>