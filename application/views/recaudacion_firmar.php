<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
	<div class="container-fluid">
		<div class="col-md-12">
			<h3 style="font-size: 20px;">Firmar recaudación</h3>
			<hr>
      <div class="alert alert-success" role="alert">
        <strong>Recaudación realizada con éxito! Firmar para finalizar</strong>
      </div>
      ...
      <p style="font-weight: bold">A <?php echo date('d')." de ".date('m')." de ".date('Y'); ?></p>
		</div>
		<div class="col-md-12">
			<h4>Fdo: El recaudador</h4>
			<div>
				<canvas id="canvas1" width="300" height="200"></canvas>
				<div class="gui">
				  <a style="text-decoration: underline; font-size: 14px" id="bt-clear1">Limpiar</a>
				</div>
			</div>	 
		</div>
		<div class="col-md-12">
			<h4>Fdo: El responsable del local</h4>
			<div>
				<canvas id="canvas2" width="300" height="200"></canvas>
				<div class="gui">
				  <a style="text-decoration: underline; font-size: 14px" id="bt-clear2">Limpiar</a>
				</div>
			</div>
		</div>
		<div class="col-md-6 col-sm-12" style="float: left; width: 100%; padding: 0;">
			<div class="btn-group pull-right" style="margin: 20px 0;">
				...
				<input id="reca" type="hidden" name="recaudacion" value="<?php echo $recaudar->id; ?>">
				<input id="salon" type="hidden" name="salon" value="<?php echo $salon; ?>">
				<button id="submit" type="submit" class="btn btn-danger dropdown-toggle">
					Aceptar 
				</button> 
			</div>
		</div>
    ...
    $.ajax({
      ...
      data: { 
         ...
         salon: salon
      	...
      	window.location.href = "../recaudacion_finalizada/"+reca;
    });
  }
