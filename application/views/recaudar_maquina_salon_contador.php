<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
	<div class="container-fluid">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart('recaudar_maquina_salon_contador_form/', 'id="myform"'); ?>
			...
			<div class="col-md-5 col-sm-12 col-xs-12" style="padding: 0; border: 1px solid #000">
				...
				<div style="width: 100%; border-bottom: 1px solid #000; float: left">
					<div style="width: 34%; height: 30px; float: left; border-right: 1px solid #000; padding-top: 4px;">
						<p style="font-weight: bold; text-align: center; margin: 0">Total Pasos</p>
					</div>
					<div style="width: 33%; height: 30px; float: left; border-right: 1px solid #000; text-align: center; padding-top: 2px;">
						<input type="text" name="entrada_total_pasos" inputmode="numeric" style="width: 100%">
					</div>
					<div style="width: 33%; height: 30px; float: left; text-align: center; padding-top: 2px;">
						<input type="text" name="salida_total_pasos" inputmode="numeric" style="width: 100%">
					</div>
				</div>
				...
				<div style="width: 100%; border-bottom: 1px solid #000; float: left">
					...
					<div style="width: 33%; height: 30px; float: left; border-right: 1px solid #000; text-align: center; padding-top: 2px;">
						<input type="text" name="entrada_total_euros" inputmode="numeric" style="width: 100%">
					</div>
					<div style="width: 33%; height: 30px; float: left; text-align: center; padding-top: 2px;">
						<input type="text" name="salida_total_euros" inputmode="numeric" style="width: 100%">
					</div>
				</div>
				...
				<div style="width: 100%; border-bottom: 1px solid #000; float: left">
					...
					<div style="width: 33%; height: 30px; float: left; border-right: 1px solid #000; text-align: center; padding-top: 2px;">
						<input type="text" name="entrada_parcial_pasos" inputmode="numeric" style="width: 100%">
					</div>
					<div style="width: 33%; height: 30px; float: left; text-align: center; padding-top: 2px;">
						<input type="text" name="salida_parcial_pasos" inputmode="numeric" style="width: 100%">
					</div>
				</div>
				...
				<div style="width: 100%; border-bottom: 1px solid #000; float: left">
					...
					<div style="width: 33%; height: 30px; float: left; border-right: 1px solid #000; text-align: center; padding-top: 2px;">
						<input type="text" name="entrada_parcial_euros" inputmode="numeric" style="width: 100%">
					</div>
					<div style="width: 33%; height: 30px; float: left; text-align: center; padding-top: 2px;">
						<input type="text" name="salida_parcial_euros" inputmode="numeric" style="width: 100%">
					</div>
				</div>
	  		...
	  		<div class="col-md-5 col-sm-12 col-xs-12" style="padding: 0; border: 1px solid #000">
				...
				<div style="width: 100%; border-bottom: 1px solid #000; float: left">
					...
					<div style="visibility: hidden; width: 33%; height: 30px; float: left; border-right: 1px solid #000; text-align: center; padding-top: 2px;">
						<input type="text" name="total_pasos" inputmode="numeric" style="width: 100%">
					</div>
					<div style="width: 33%; height: 30px; float: left; text-align: center; padding-top: 2px;">
						<input type="text" name="neto_total_pasos" inputmode="numeric" style="width: 100%">
					</div>
				</div>
				...
				<div style="width: 100%; border-bottom: 1px solid #000; float: left">
					...
					<div style="visibility: hidden; width: 33%; height: 30px; float: left; border-right: 1px solid #000; text-align: center; padding-top: 2px;">
						<input type="text" name="total_euros" inputmode="numeric" style="width: 100%">
					</div>
					<div style="width: 33%; height: 30px; float: left; text-align: center; padding-top: 2px;">
						<input type="text" name="neto_total_euros" inputmode="numeric" style="width: 100%">
					</div>
				</div>
				...
				<div style="width: 100%; border-bottom: 1px solid #000; float: left">
					...
					<div style="visibility: hidden; width: 33%; height: 30px; float: left; border-right: 1px solid #000; text-align: center; padding-top: 2px;">
						<input type="text" name="parcial_pasos" inputmode="numeric" style="width: 100%">
					</div>
					<div style="width: 33%; height: 30px; float: left; text-align: center; padding-top: 2px;">
						<input type="text" name="neto_parcial_pasos" inputmode="numeric" style="width: 100%">
					</div>
				</div>
				...
				<div style="width: 100%; border-bottom: 1px solid #000; float: left">
					...
					<div style="visibility: hidden; width: 33%; height: 30px; float: left; border-right: 1px solid #000; text-align: center; padding-top: 2px;">
						<input type="text" name="parcial_euros" inputmode="numeric" style="width: 100%">
					</div>
					<div style="width: 33%; height: 30px; float: left; text-align: center; padding-top: 2px;">
						<input type="text" name="neto_parcial_euros" inputmode="numeric" style="width: 100%">
					</div>
				</div>
				...
				<div style="width: 100%; border-bottom: 1px solid #000; float: left">
					...
					<div style="width: 33%; height: 30px; float: left; border-right: 1px solid #000; text-align: center; padding-top: 2px;">
						<input type="text" name="total2" style="width: 100%" value="<?php if(isset($ultima->neto_total_euros) && $ultima->neto_total_euros != ''){ echo $ultima->neto_total_euros; }else{ echo "0"; } ?>" >
					</div>
				</div>
