	...
	<div class="container-fluid">
		<div class="col-md-12">
			<h3 style="font-size: 20px;">
				...
				<a href="<?php echo base_url('recaudar_salones_contador'); ?>" style="color: #000; text-decoration: none">Recaudar salon</a>
			</h3>
			<hr>
			...
			<?php echo form_open_multipart('recaudar_salones_contador_form/', 'id="myform"'); ?>
			<div class="col-md-12" style="padding: 0" id="div_mantenimientos_centrar">
				<div class="panel panel-default col-md-4 col-sm-12 paneles_form">
					<div class="panel-heading" style="cursor: pointer">
						Salon<span style="float: right" class="glyphicon glyphicon-triangle-top"></span>
					</div>
		...
		<?php if(isset($salon)){ ?>
		<div class="col-md-12">
			<h4 style="font-size: 20px; margin-top: 40px; float: left; width: 100%;"><a href="<?php echo base_url('recaudar'); ?>" style="color: #000; text-decoration: none">Maquinas</a></h4>
			<hr>
